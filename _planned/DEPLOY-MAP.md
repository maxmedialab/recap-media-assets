...
**Pickup state (updated 2026-07-09 ~10:00):** homepage design pass DONE + verified (3-beat pain strip, who-for checklist + non-profit callout, 3 tier cards with Start-here on Capture; .p2- styles in a marked head block — fold into style.css at approval; screenshots: _planned/preview-shots/). §3b scannability sweep of the 3 EN + 4 NO pages IN PROGRESS. ▶ NEW for Max: homepage FAQ has a PRE-EXISTING schema/visible drift on 4 answers — Q5 materially contradicts (LD: 5–7 days full package · visible: 7 days photos / 14 video); which numbers are true? Timeline note: the 02:23 + 07:23 scheduled runs both fired and auto-disabled but left no commits/worklog — all completion work came from the live session's workflows.
